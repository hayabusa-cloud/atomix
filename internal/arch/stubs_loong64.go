...
//
// LoongArch uses LL/SC (Load-Linked/Store-Conditional) for atomic operations.
// Memory ordering is controlled by DBAR (Data Barrier) instructions with
// different hint values for acquire/release semantics.
//
...
//   - LL.W/SC.W: Load-linked/store-conditional (word)
//   - AMADD/AMSWAP: Atomic memory operations
//   - DBAR: Data barrier (DBAR 0 = full barrier)

// =============================================================================
// 32-bit Signed Integer Operations
// =============================================================================

// All Load/Store require assembly for proper DBAR handling on LoongArch.
//
//go:noescape
...
// DBAR instructions with different hint values for ordering control.
